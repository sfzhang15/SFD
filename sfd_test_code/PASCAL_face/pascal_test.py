...
caffe_root = '../../'  # this file is expected to be in {sfd_root}/sfd_test_code/PASCAL_face
import os
os.chdir(caffe_root)
import sys
...
count = 0
Path = 'Path to the images of PASCAL VOC 2012'
f = open('./sfd_test_code/PASCAL_face/sfd_pascal_dets.txt', 'wt')
for Name in open('./sfd_test_code/PASCAL_face/pascal_img_list.txt'):
    ...
    for i in xrange(det_conf.shape[0]):
        ...
        # simple fitting to PASCAL face, because the gt box of PASCAL face is longer than the gt box of training data (i.e., WIDER FACE)
